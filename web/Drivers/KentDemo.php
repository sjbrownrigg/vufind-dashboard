 ...
 * @link     http://vufind.org/wiki/building_an_ils_driver Wiki
 */
class KentDemo implements DriverInterface
{
    ...
    public function getPickUpLocations($patron = false, $holdDetails = null)
    {
        return array(
            array(
                'locationID' => '131',
                'locationDisplay' => 'Core Text Collection'
            ),
            array(
                'locationID' => '124',
                'locationDisplay' => 'University of Kent at Medway - Drill Hall Library'
            ),
            array(
                'locationID' => '126',
                'locationDisplay' => 'Tonbridge Centre Library'
            )
        );
    }
